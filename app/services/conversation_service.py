...
from app.services import lead_evaluation_service
        ...
        try:
            ...
            if chatbot_activo:
                try:
                    ...
                    # Verificar si hay una respuesta personalizada en los metadatos (para captura de datos)
                    if metadata and metadata.get("custom_response"):
                        response = metadata.get("custom_response")
                    else:
                        # Generar respuesta con el servicio de langchain
